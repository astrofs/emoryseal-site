      ...
      <section className="relative py-24 bg-gradient-to-br from-slate-950 via-cyan-950 to-teal-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100/90 leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-cyan-50 to-white border border-cyan-100 rounded-3xl p-10"
            >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-teal-50 to-white border border-teal-100 rounded-3xl p-10"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: BookOpen, title: 'Education', desc: 'Commitment to learning and sharing knowledge', gradient: 'from-cyan-500 to-blue-600' },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="text-center mb-12">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
